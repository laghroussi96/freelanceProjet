...
public class CommentaireController implements Serializable {
    ...
    public void setSelected(Commentaire selected) {
    ...
    private CommentaireFacade getFacade() {
        return ejbFacade;
    }

    public Commentaire prepareCreate() {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("CommentaireUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("CommentaireDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Commentaire> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class CommentaireControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Commentaire) {
                Commentaire o = (Commentaire) object;
                return getStringKey(o.getId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Commentaire.class.getName()});
                return null;
            }
        }
