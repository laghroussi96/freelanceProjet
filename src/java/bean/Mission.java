...
public class Mission implements Serializable {
    ...
    public Mission(Long id, String titre, String commentaire, Double minBudget, Double maxBudget, boolean isAccepted, Date dateAcceptation, Date datePublication, Date dateLimite) {
        this.id = id;
        this.titre = titre;
    ...
    public String toString() {
        return "Mission{" + "id=" + id + ", titre=" + titre + ", commentaire=" + commentaire + ", minBudget=" + minBudget + ", maxBudget=" + maxBudget + ", isAccepted=" + isAccepted + ", dateAcceptation=" + dateAcceptation + ", datePublication=" + datePublication + ", dateLimite=" + dateLimite + '}';
    }
